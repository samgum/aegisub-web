...
export const AEGISUB_DIALOG_PARITY: Record<UpstreamAegisubDialog, DialogParityEntry> = {
  ...
  "jump-to": { status: "partial", surface: "Time prompt; native frame entry and VFR mapping pending" },
  ...
  "style-editor": { status: "partial", surface: "Style fields inside Style Manager; native live preview workflow unverified" },
  ...
  "video-details": { status: "partial", surface: "File/dimensions/duration; actual packet-derived frame-rate data pending" },
